document.addEventListener("DOMContentLoaded", async function () {
    ...
    projectListSection.id = "projectListSection";
    ...
    async function genererPortfolioModale(portfolioElements) {
        ...
        for (let i = 0; i < portfolioElements.length; i++) {
          ...
          form.addEventListener("submit", async function(event) {
            ...
            newCaption.textContent = data.title;
            ...
            // Étape 2 : Ajouter dynamiquement le projet à la modale
            const projectListSection = document.getElementById("projectListSection"); // Sélectionner la section modale
            const newModalItem = document.createElement("div");
            newModalItem.style.position = "relative";
            ...
            newModalItem.appendChild(modalImage);
            newModalItem.appendChild(deleteIcon);

            projectListSection.appendChild(newModalItem);
